      ...
      {(editMode ? editExperience : profileExperience)?.length > 0 ? (
        <div className="relative pl-6">
          ...
          <div className="space-y-8 relative z-10">
            {(editMode ? editExperience : profileExperience).map(
              (exp, index) => (
                <motion.article
                  key={exp.id || index}
                  ...
                  {editMode ? (
                    ...
                    <div className="space-y-2 w-full">
                      <div className="flex items-center gap-3">
                        ...
                        {exp.end === "Present" && (
                          <span className="inline-block bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200 text-xs font-bold px-3 py-1 rounded-full ml-2">
                            Current
                          </span>
                        )}
                      </div>
